class Car {
    ...
    constructor(marca: string, modelo: string, categoria: string,
        ano: number, quilometragem: number, valor: number) {
            this.Marca = marca;
            this.Modelo = modelo;
...
//!!!!!POST!!!!!!
  ...
  async function postData(car: Car) {
...
//!!!!!PATCH!!!!
  ...
  async function patchData(id: number, valor: number) {
